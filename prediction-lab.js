...
(function(){
 ...
 function close(id,closingOdds,result=null){
  ...
  write(rows);window.dispatchEvent(new CustomEvent('edgeiq:predictions-updated'));return r;
 }
 function summary(){
