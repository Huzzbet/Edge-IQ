...
(function(){
  ...
  function flatten(data){
    ...
    for(const e of (data?.events||[])){
      if(!Array.isArray(e.items))continue;const base={eventId:e.event_id,event:`${e.home_team||''} v ${e.away_team||''}`,start:e.start_time,league:e.league||'',sport:e.sport||'',home:e.home_team||e.home,away:e.away_team||e.away,modelSource:e.model_source||null,modelGamesUsed:e.model_games_used||null};
